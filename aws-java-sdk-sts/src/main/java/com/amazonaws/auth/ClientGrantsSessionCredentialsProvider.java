...
import com.amazonaws.services.securitytoken.model.AssumeRoleWithClientGrantsRequest;
import com.amazonaws.services.securitytoken.model.AssumeRoleWithClientGrantsResult;
 ...
 */
public class ClientGrantsSessionCredentialsProvider implements AWSSessionCredentialsProvider {
    ...
    /**
     * Constructs a new ClientGrantsSessionCredentialsProvider, which will use the
     ...
     */
    public ClientGrantsSessionCredentialsProvider(String wifToken, String wifProvider, String roleArn) {
     ...
     */
    public ClientGrantsSessionCredentialsProvider(String wifToken, String wifProvider, String roleArn, ClientConfiguration clientConfiguration) {
     ...
     */
    public ClientGrantsSessionCredentialsProvider(String wifToken, String wifProvider, String roleArn, AWSSecurityTokenService stsClient) {
   ...
   /**
     ...
     * seconds. Values must be supported by AssumeRoleWithClientGrantsRequest.
     *
     * @see com.amazonaws.services.securitytoken.model.AssumeRoleWithClientGrantsRequest
     *
   ...
   /**
     ...
     *
     */
    public ClientGrantsSessionCredentialsProvider withSessionDuration(int sessionDuration) {
   ...
   /**
     ...
     *
     */
    public ClientGrantsSessionCredentialsProvider withRefreshThreshold(int refreshThreshold) {
     ...
     *
     * @see com.amazonaws.services.securitytoken.model.AssumeRoleWithClientGrantsResult
     *
    ...
    private void startSession() {
        AssumeRoleWithClientGrantsResult sessionTokenResult = securityTokenService
                .assumeRoleWithClientGrants(new AssumeRoleWithClientGrantsRequest().withClientGrantsToken(wifToken)
                        .withDurationSeconds(this.sessionDuration));
        Credentials stsCredentials = sessionTokenResult.getCredentials();

        subjectFromWIF = sessionTokenResult.getSubjectFromClientGrantsToken();
