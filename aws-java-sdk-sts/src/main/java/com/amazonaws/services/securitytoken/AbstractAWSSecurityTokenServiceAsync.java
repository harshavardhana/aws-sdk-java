...
public class AbstractAWSSecurityTokenServiceAsync extends AbstractAWSSecurityTokenService implements AWSSecurityTokenServiceAsync {
    ...
    @Override
    public java.util.concurrent.Future<AssumeRoleWithClientGrantsResult> assumeRoleWithClientGrantsAsync(AssumeRoleWithClientGrantsRequest request) {

        return assumeRoleWithClientGrantsAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<AssumeRoleWithClientGrantsResult> assumeRoleWithClientGrantsAsync(AssumeRoleWithClientGrantsRequest request,
            com.amazonaws.handlers.AsyncHandler<AssumeRoleWithClientGrantsRequest, AssumeRoleWithClientGrantsResult> asyncHandler) {
