...
/**
 * <p>
 * Contains the response to a successful <a>AssumeRoleWithClientGrants</a> request, including temporary AWS credentials
 * that can be used to make AWS requests.
 * </p>
 *
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRoleWithClientGrants" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssumeRoleWithClientGrantsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssumeRoleWithClientGrantsResult withCredentials(Credentials credentials) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssumeRoleWithClientGrantsResult == false)
            return false;
        AssumeRoleWithClientGrantsResult other = (AssumeRoleWithClientGrantsResult) obj;
    ...
    @Override
    public AssumeRoleWithClientGrantsResult clone() {
        try {
            return (AssumeRoleWithClientGrantsResult) super.clone();
